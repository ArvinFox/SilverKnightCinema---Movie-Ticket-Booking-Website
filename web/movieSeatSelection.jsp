...
<head>
    ...
    <title>Seat Selection | SilverKnight Cinema</title>
...
<body>
    ...
    <div class="booking-details-top">
        ...
        <div class="booking-details-sub-top movie-locations">
            <h5><i class='fas fa-map-marker-alt'>&nbsp;&nbsp;</i>${hall.name} (${hall.cinema})</h5>
    ...
    <script>
        document.querySelector('.btn-navigate-back').addEventListener('click', () => {
            const urlParameters = new URLSearchParams(window.location.search);
            const movieId = urlParameters.get("movieId");

            window.location.href = 'movies?movieId=' + movieId;
        });
    </script>
</body>
</html>
